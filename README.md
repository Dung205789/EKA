...
## Known issues
- Missing Ollama models can break chat/embedding.
- Port conflicts (e.g. 11434) may prevent Ollama startup.
- First-time model pull/build can be slow.

## Beg for money
If EKA helps your team, please support development:
- Sponsor maintenance and bug fixes
- Fund better parsing/reranking features
- Contribute compute resources for model evaluation

Every contribution helps keep the project improving ❤️